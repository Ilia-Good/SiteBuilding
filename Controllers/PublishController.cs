...
public class PublishController : ControllerBase
{
    ...
    private static string BuildFinalHtml(BuilderStateRequest state, Guid siteId, string apiBaseUrl)
    {
        ...
        html.AppendLine($"        var endpoints = ['{EscapeHtml(apiBaseUrl)}/api/contact/send-simple', '{DefaultPublicApiBaseUrl}/api/contact/send-simple', '/api/contact/send-simple', '{EscapeHtml(apiBaseUrl)}/api/contact/send', '{DefaultPublicApiBaseUrl}/api/contact/send', '/api/contact/send'];");
        ...
        html.AppendLine("        formPayload.append('honeypot', payload.honeypot || '');");
        html.AppendLine("        try {");
